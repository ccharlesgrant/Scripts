(function() {
    ...
    sendBtn.onclick = () => {
        ...
        // === FIXED FILLING: Clear all + set only what we want + force 0 where needed ===
        villages.forEach(v => {
            ...
            // 2. Set the actual amounts we calculated
            ...
            // 3. Only check the row if we're sending anything at all
